...
static inline void shd_setup_dfstack_st(shd_dfstack_t *vstack, void *pool, u32 size) {
    if(!vstack) return;
...
static inline void shd_teardown_dfstack_st(shd_dfstack_t *vstack) {
    if(!vstack) return;
...
static inline void *shd_dfstack_push_st(shd_dfstack_t *vstack, u32 size) {
    if (!vstack)
        return 0;
...
/* static inline void *shd_dfstack_push_aligned_st(
...
static inline void shd_dfstack_pop_st(shd_dfstack_t *vstack, void *addr) {
    if (!vstack)
        return;
...
static inline void shd_dfstack_clear_st(shd_dfstack_t *vstack) {
    if (!vstack)
        return;
